       ...
       <v-container fill-height fluid grid-list-xl>    
            <v-layout justify-center wrap>            
                    <v-flex xs12 md8>
                        <!-- <h1 style="display: "> </h1> -->
                    <v-card>
                            <material-card class="v-card-profile" style="background-color: #fffafa !important; border-color: #fffafa !important" >
                                <v-avatar slot="offset" class="mx-auto d-block" size="180">
                                    <img :src="usuarioUp.imageData" alt="Foto de perfil" title="Foto  de perfil" style="margin-top:5%">
                            ...
                            <v-card elevation="3" style="background-color: #fffafa !important; border-color: #fffafa !important">
                                <v-form>
                                    <v-container py-0>
                                        <v-layout wrap>
                                            <v-flex xs12 md4>
            ...
            <v-dialog v-model="vorf" persistent width="400px">            
                <v-card class="text-xs-center">
                    <v-card-title class="text-xs-center">
                        <span class="headline" style="margin:auto;">Confirmação de segurança</span>
                    </v-card-title>
                    <v-card-text class="text-xs-center">                    
                        <v-flex xs12>
